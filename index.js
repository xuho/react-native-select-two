...
class Select2 extends Component {
    ...
    render() {
        let {
            ...
            selectedTitleStyle, buttonTextStyle, buttonStyle, showSearchBox,hideName
        } = this.props;
            ...
            <TouchableOpacity
                ...
                </Modal>
                {
                    preSelectedItem.length > 0
                        ? (
                            isSelectSingle
                                ? <Text style={[styles.selectedTitlte, this.defaultFont, selectedTitleStyle, { color: '#333' }]}>{!hideName && preSelectedItem[0].name}</Text>
